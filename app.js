...
ご予約のキャンセルまたは日時変更を希望される場合は、できる限り早めに当店までご連絡ください。

特に出張施術の場合、スタッフが移動を開始した後や、到着直前でのキャンセルは、他のお客様のご予約調整にも影響が生じるため、直前のキャンセル・変更はお控えください。

無断キャンセルや、予約時間直前の大幅な変更が繰り返される場合には、以後のご予約をお断りする場合があります。`;
